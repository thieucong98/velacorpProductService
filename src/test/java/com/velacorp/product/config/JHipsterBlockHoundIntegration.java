package com.velacorp.product.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.velacorp.product.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.velacorp.product.security.DomainUserDetailsService", "createSpringSecurityUser");
