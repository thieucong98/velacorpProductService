...
/**
 * REST controller for managing {@link com.velacorp.product.domain.Product}.
 */
@RestController
...
public class ProductResource {
    ...
    private static final String ENTITY_NAME = "velacorpProductServiceProduct";
    ...
    public Mono<ResponseEntity<List<ProductDTO>>> getAllProducts(
        ...
        @org.springdoc.core.annotations.ParameterObject ProductGetVM query,
        ServerHttpRequest request
    ) {
        log.debug("REST request to get a page of Products");
        return productService
            .countAll()
            .zipWith(productService.findAll(pageable, query).collectList())
            .map(
                countWithEntities ->
                    ResponseEntity.ok()
                        .headers(
